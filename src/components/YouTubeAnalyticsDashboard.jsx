      ...
      <header className="bg-red-600 text-white p-6 shadow-lg">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <h1 className="text-2xl font-bold">ViewStat Pro</h1>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <div className="flex items-center">
                ...
                <h3 className="text-xl font-bold">ViewStat Pro</h3>
              </div>
              <p className="text-gray-400 mt-2">Advanced YouTube Analytics Platform</p>
            </div>
            <p className="text-gray-400 text-sm">© 2025 ViewStat Pro. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
